const initFeatures = () => {
    ...
    if(!localStorage.getItem("featureFlags")) {localStorage.setItem("featureFlags", JSON.stringify([
            ...
            {name: "ffImprovedQuestions", description: "Improved Questions", active: false}
        ]))
    }
}
